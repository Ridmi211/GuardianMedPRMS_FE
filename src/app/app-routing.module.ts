...
const routes: Routes = [ 
  ...
  {path:'prescriptions/add', component: AddPrescriptionComponent  , canActivate: [AuthGuard], data: { roles: ['ROLE_SUPER_ADMIN']}},
  ...
  {path:'admins/all', component:ViewAdminsComponent , canActivate: [AuthGuard], data: { roles: ['ROLE_SUPER_ADMIN']}} ,
  {path:'admins/add', component:AddAdminsComponent , canActivate: [AuthGuard], data: { roles: ['ROLE_SUPER_ADMIN']}},
  {path:'admins/edit/:id', component:EditAdminComponent , canActivate: [AuthGuard], data: { roles: ['ROLE_SUPER_ADMIN']}},
  {path:'admins/reset-password/:id', component:ResetPasswordComponent , canActivate: [AuthGuard]},
  {path:'bills/add', component:AddBillsComponent , canActivate: [AuthGuard],data: { roles: ['ROLE_ADMIN']}},
  ...
  {path:'super-admin-dashboard',component:SuperAdminDashboardComponent,canActivate: [AuthGuard], data: { roles: ['ROLE_SUPER_ADMIN']}},
